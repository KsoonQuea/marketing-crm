...
class CreateView12ToCollectionRpt extends Migration
{
    public function up()
    {
...
FROM (
    ...
    if(COUNT(payments.id) = 0, 0, (if(SUM(payments.paid_amount) >= disburses.service_fee_amount, 2, 1))) AS 'payment_status',
...
;
    ...
    {
        Schema::dropIfExists('view12_to_collection_rpt');
    }
}
