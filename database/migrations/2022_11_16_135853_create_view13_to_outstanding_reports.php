...
class CreateView13ToOutstandingReports extends Migration
{
    public function up()
    {
...
0 AS 'disb',
payments.date AS 'or_date', payments.cheque_no, payments.`or`, details.sst_paid_date,
...
ORDER BY o_report.inv_date, o_report.or_date ;
    ...
    {
        Schema::dropIfExists('view13_to_outstanding_reports');
    }
}
