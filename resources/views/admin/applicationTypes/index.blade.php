<x-admin.app-layout>
    ...
    <x-admin.breadcrumb>
        <x-slot:breadcrumb_title>
            <h3>{{ trans('cruds.applicationType.title_singular') }} {{ trans('global.list') }}</h3>
        </x-slot:breadcrumb_title>
        <li class="breadcrumb-item active">{{ trans('cruds.applicationType.title_singular') }} {{ trans('global.list') }}</li>
        <x-slot:breadcrumb_action>
            @can('application_type_create_2')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-primary" href="{{ route('admin.application-types.create') }}">
                            {{ trans('global.add') }} {{ trans('cruds.applicationType.title_singular') }}
                        </a>
                    </div>
                </div>
            @endcan
...
{{--    reload() {--}}
{{--        $('#applicationtype-table').DataTable().ajax.reload();--}}
{{--    },--}}
{{--    clear() {--}}
