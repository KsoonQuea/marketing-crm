    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.states.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postcode_format') ? 'is-invalid' : '' }}" type="text" name="postcode_format" id="postcode_format" value="{{ old('postcode_format', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_postcode') ? 'is-invalid' : '' }}" type="text" name="other_postcode" id="other_postcode" value="{{ old('other_postcode', '') }}">
