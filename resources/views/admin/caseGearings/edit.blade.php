...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.caseGearing.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.case-gearings.update", [$caseGearing->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="borrow_item">{{ trans('cruds.caseGearing.fields.borrow_item') }}</label>
                <input class="form-control {{ $errors->has('borrow_item') ? 'is-invalid' : '' }}" type="text" name="borrow_item" id="borrow_item" value="{{ old('borrow_item', $caseGearing->borrow_item) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('borrow_price') ? 'is-invalid' : '' }}" type="number" name="borrow_price" id="borrow_price" value="{{ old('borrow_price', $caseGearing->borrow_price) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('financing_amount') ? 'is-invalid' : '' }}" type="number" name="financing_amount" id="financing_amount" value="{{ old('financing_amount', $caseGearing->financing_amount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_redemtion') ? 'is-invalid' : '' }}" type="number" name="bank_redemtion" id="bank_redemtion" value="{{ old('bank_redemtion', $caseGearing->bank_redemtion) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $caseGearing->date) }}">
                @if($errors->has('date'))
                    <div class="invalid-feedback">
                        {{ $errors->first('date') }}
                    </div>
