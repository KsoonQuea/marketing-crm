...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.caseCommitment.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.case-commitments.update", [$caseCommitment->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('case') ? 'is-invalid' : '' }}" name="case_id" id="case_id">
                    @foreach($cases as $id => $entry)
                        <option value="{{ $id }}" {{ (old('case_id') ? old('case_id') : $caseCommitment->case->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('case'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('house_loan') ? 'is-invalid' : '' }}" type="number" name="house_loan" id="house_loan" value="{{ old('house_loan', $caseCommitment->house_loan) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('term_loan') ? 'is-invalid' : '' }}" type="number" name="term_loan" id="term_loan" value="{{ old('term_loan', $caseCommitment->term_loan) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hire_purchase') ? 'is-invalid' : '' }}" type="number" name="hire_purchase" id="hire_purchase" value="{{ old('hire_purchase', $caseCommitment->hire_purchase) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('credit_card_limit') ? 'is-invalid' : '' }}" type="number" name="credit_card_limit" id="credit_card_limit" value="{{ old('credit_card_limit', $caseCommitment->credit_card_limit) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('trade_line_limit') ? 'is-invalid' : '' }}" type="number" name="trade_line_limit" id="trade_line_limit" value="{{ old('trade_line_limit', $caseCommitment->trade_line_limit) }}" step="0.01">
