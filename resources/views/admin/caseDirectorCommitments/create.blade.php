...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.caseDirectorCommitment.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.case-director-commitments.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('director_name') ? 'is-invalid' : '' }}" type="text" name="director_name" id="director_name" value="{{ old('director_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('personal_loan') ? 'is-invalid' : '' }}" type="number" name="personal_loan" id="personal_loan" value="{{ old('personal_loan', '0') }}" step="0.01">
