...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.caseRequest.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.case-requests.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('request_type') ? 'is-invalid' : '' }}" name="request_type_id" id="request_type_id">
                    @foreach($request_types as $id => $entry)
                        <option value="{{ $id }}" {{ old('request_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facility_type') ? 'is-invalid' : '' }}" type="text" name="facility_type" id="facility_type" value="{{ old('facility_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="number" name="amount" id="amount" value="{{ old('amount', '0.00') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('specific_concern') ? 'is-invalid' : '' }}" type="text" name="specific_concern" id="specific_concern" value="{{ old('specific_concern', '') }}">
