<x-admin.app-layout>
    ...
    <x-admin.breadcrumb>
        <x-slot:breadcrumb_title>
            <h3>{{ trans('cruds.requestType.title_singular') }} {{ trans('global.list') }}</h3>
        </x-slot:breadcrumb_title>
        <li class="breadcrumb-item active">{{ trans('cruds.requestType.title_singular') }} {{ trans('global.list') }}</li>
        <x-slot:breadcrumb_action>
            @can('request_type_create_2')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-primary" href="{{ route('admin.request-types.create') }}">
...
{{--    reload() {--}}
{{--        $('#requesttype-table').DataTable().ajax.reload();--}}
{{--    },--}}
{{--    clear() {--}}
        ...
        <script>
            ...
            $(function () {
                ...
                let dtOverrideGlobals = {
                    ...
                    aaSorting: [],
                    ajax: {
                        url: "{{ route('admin.request-types.index') }}",
                        data: function (d) {
