...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.caseFinancial.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.case-financials.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="current_asset">{{ trans('cruds.caseFinancial.fields.current_asset') }}</label>
                <input class="form-control {{ $errors->has('current_asset') ? 'is-invalid' : '' }}" type="number" name="current_asset" id="current_asset" value="{{ old('current_asset', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('non_current_asset') ? 'is-invalid' : '' }}" type="number" name="non_current_asset" id="non_current_asset" value="{{ old('non_current_asset', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('director_asset') ? 'is-invalid' : '' }}" type="number" name="director_asset" id="director_asset" value="{{ old('director_asset', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('related_customer_asset') ? 'is-invalid' : '' }}" type="number" name="related_customer_asset" id="related_customer_asset" value="{{ old('related_customer_asset', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_asset') ? 'is-invalid' : '' }}" type="number" name="customer_asset" id="customer_asset" value="{{ old('customer_asset', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_liabilities') ? 'is-invalid' : '' }}" type="number" name="current_liabilities" id="current_liabilities" value="{{ old('current_liabilities', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('non_current_liabilities') ? 'is-invalid' : '' }}" type="number" name="non_current_liabilities" id="non_current_liabilities" value="{{ old('non_current_liabilities', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('director_liabilities') ? 'is-invalid' : '' }}" type="number" name="director_liabilities" id="director_liabilities" value="{{ old('director_liabilities', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('related_customer_liabilities') ? 'is-invalid' : '' }}" type="number" name="related_customer_liabilities" id="related_customer_liabilities" value="{{ old('related_customer_liabilities', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_liabilities') ? 'is-invalid' : '' }}" type="number" name="customer_liabilities" id="customer_liabilities" value="{{ old('customer_liabilities', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('loan_n_hp') ? 'is-invalid' : '' }}" type="number" name="loan_n_hp" id="loan_n_hp" value="{{ old('loan_n_hp', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('share_capital') ? 'is-invalid' : '' }}" type="number" name="share_capital" id="share_capital" value="{{ old('share_capital', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('revenue') ? 'is-invalid' : '' }}" type="number" name="revenue" id="revenue" value="{{ old('revenue', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sales_cost') ? 'is-invalid' : '' }}" type="number" name="sales_cost" id="sales_cost" value="{{ old('sales_cost', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('finance_cost') ? 'is-invalid' : '' }}" type="number" name="finance_cost" id="finance_cost" value="{{ old('finance_cost', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('depreciation') ? 'is-invalid' : '' }}" type="number" name="depreciation" id="depreciation" value="{{ old('depreciation', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profit') ? 'is-invalid' : '' }}" type="number" name="profit" id="profit" value="{{ old('profit', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('financial_date') ? 'is-invalid' : '' }}" type="text" name="financial_date" id="financial_date" value="{{ old('financial_date') }}">
