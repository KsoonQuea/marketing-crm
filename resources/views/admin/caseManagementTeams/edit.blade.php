...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.caseManagementTeam.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.case-management-teams.update", [$caseManagementTeam->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('case') ? 'is-invalid' : '' }}" name="case_id" id="case_id">
                    @foreach($cases as $id => $entry)
                        <option value="{{ $id }}" {{ (old('case_id') ? old('case_id') : $caseManagementTeam->case->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('case'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $caseManagementTeam->name) }}">
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('age') ? 'is-invalid' : '' }}" type="number" name="age" id="age" value="{{ old('age', $caseManagementTeam->age) }}" step="1">
                @if($errors->has('age'))
                    <div class="invalid-feedback">
                        {{ $errors->first('age') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $caseManagementTeam->phone) }}">
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $caseManagementTeam->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation') ? 'is-invalid' : '' }}" type="text" name="designation" id="designation" value="{{ old('designation', $caseManagementTeam->designation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shareholding') ? 'is-invalid' : '' }}" type="number" name="shareholding" id="shareholding" value="{{ old('shareholding', $caseManagementTeam->shareholding) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('responsible_area') ? 'is-invalid' : '' }}" type="text" name="responsible_area" id="responsible_area" value="{{ old('responsible_area', $caseManagementTeam->responsible_area) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('experience_year') ? 'is-invalid' : '' }}" type="number" name="experience_year" id="experience_year" value="{{ old('experience_year', $caseManagementTeam->experience_year) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('case_year') ? 'is-invalid' : '' }}" type="number" name="case_year" id="case_year" value="{{ old('case_year', $caseManagementTeam->case_year) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('director_relationship') ? 'is-invalid' : '' }}" type="text" name="director_relationship" id="director_relationship" value="{{ old('director_relationship', $caseManagementTeam->director_relationship) }}">
