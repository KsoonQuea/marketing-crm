<x-admin.app-layout>
    ...
    <x-admin.breadcrumb>
        <x-slot:breadcrumb_title>
            <h3>{{ trans('global.edit') }} {{ trans('cruds.director.title_singular') }}</h3>
        </x-slot:breadcrumb_title>
        ...
        <li class="breadcrumb-item active">{{ trans('global.edit') }} {{ trans('cruds.director.title_singular') }}</li>
    </x-admin.breadcrumb>
                ...
                <form method="POST" action="{{ route("admin.directors.update", [$director->id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-12 col-md-4">
                            ...
                            <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $director->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group col-12 col-md-4">
                            ...
                            <input class="form-control {{ $errors->has('ic') ? 'is-invalid' : '' }}" type="text" name="ic" id="ic" value="{{ old('ic', $director->ic) }}">
                            @if($errors->has('ic'))
                            <div class="invalid-feedback">
                                {{ $errors->first('ic') }}
                            </div>
                        ...
                        <div class="form-group col-12 col-md-4">
                            ...
                            <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $director->email) }}">
                            @if($errors->has('email'))
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
                            </div>
                        ...
                        <div class="form-group col-12 col-md-4">
                            <label for="phone">{{ trans('cruds.director.fields.phone') }}</label>
                            <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $director->phone) }}">
                            @if($errors->has('phone'))
                            <div class="invalid-feedback">
                                {{ $errors->first('phone') }}
                            </div>
                        ...
                        <div class="form-group col-12 col-md-4">
                            ...
                            <select class="form-control select2 {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender">
                                ...
                                <option value="{{ $key }}" {{ old('gender', $director->gender) === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-12 col-md-4">
                            ...
                            <select class="form-control select2 {{ $errors->has('marital_status') ? 'is-invalid' : '' }}" name="marital_status" id="marital_status">
                                ...
                                <option value="{{ $key }}" {{ old('marital_status', $director->marital_status) === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input class="form-control {{ $errors->has('address_1') ? 'is-invalid' : '' }}" type="text" name="address_1" id="address_1" value="{{ old('address_1', $director->address_1) }}">
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input class="form-control {{ $errors->has('address_2') ? 'is-invalid' : '' }}" type="text" name="address_2" id="address_2" value="{{ old('address_2', $director->address_2) }}">
                        ...
                        <div class="form-group col-12 col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('postcode') ? 'is-invalid' : '' }}" type="text" name="postcode" id="postcode" value="{{ old('postcode', $director->postcode) }}">
                        ...
                        <div class="form-group col-12 col-md-3">
                            ...
                            <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city" id="city">
                                ...
                                <option value="{{ $id }}" {{ (old('city') ? old('city') : $director->city->id ?? '') == $id ? 'selected' : '' }}>
                                    {{ $entry }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-12 col-md-3">
                            ...
                            <select class="form-control select2 {{ $errors->has('state') ? 'is-invalid' : '' }}"
                                ...
                                <option value="{{ $id }}" {{ (old('state') ? old('state') : $director->state->id ?? '') == $id ? 'selected' : '' }}>
                                    {{ $entry }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-12 col-md-3">
                            ...
                            <select class="form-control select2 {{ $errors->has('country') ? 'is-invalid' : '' }}" name="country" id="country">
                                ...
                                <option value="{{ $id }}" {{ (old('country_id') ? old('country_id') : $director->country->id ?? '') == $id ? 'selected' : '' }}>
                                    {{ $entry }}
                                </option>
                                @endforeach
                            </select>
