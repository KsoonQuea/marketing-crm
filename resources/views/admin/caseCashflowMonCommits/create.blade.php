...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.caseCashflowMonCommit.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.case-cashflow-mon-commits.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('avg_mon_end_bank_balances') ? 'is-invalid' : '' }}" type="number" name="avg_mon_end_bank_balances" id="avg_mon_end_bank_balances" value="{{ old('avg_mon_end_bank_balances', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('avg_mon_credit_transactions') ? 'is-invalid' : '' }}" type="number" name="avg_mon_credit_transactions" id="avg_mon_credit_transactions" value="{{ old('avg_mon_credit_transactions', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mon_commitment') ? 'is-invalid' : '' }}" type="number" name="mon_commitment" id="mon_commitment" value="{{ old('mon_commitment', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tot_mon_commitment_for_directors') ? 'is-invalid' : '' }}" type="number" name="tot_mon_commitment_for_directors" id="tot_mon_commitment_for_directors" value="{{ old('tot_mon_commitment_for_directors', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tot_mon_commitment_of_directors_and_company') ? 'is-invalid' : '' }}" type="number" name="tot_mon_commitment_of_directors_and_company" id="tot_mon_commitment_of_directors_and_company" value="{{ old('tot_mon_commitment_of_directors_and_company', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('annualized_revenue') ? 'is-invalid' : '' }}" type="number" name="annualized_revenue" id="annualized_revenue" value="{{ old('annualized_revenue', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('income_factor') ? 'is-invalid' : '' }}" type="number" name="income_factor" id="income_factor" value="{{ old('income_factor', '') }}" step="0.01">
