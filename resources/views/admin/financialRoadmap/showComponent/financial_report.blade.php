<div class="container-fluid mt-1">
    ...
    <div class="row">
        ...
        <div class="col-3">
            <div class="media float-end">
                <label class="col-form-label float-end me-2">Show Answer</label>
                <div class="media-body text-end">
                    <label class="switch">
                        <input type="checkbox" id="switch-show-ans" checked="" onchange="showAnsFunc()"><span class="switch-state"></span>
                    </label>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row">
                        ...
                        @foreach($financialRoadmap_data as $financial_year_key => $financial_year_item)
                            @if($financial_year_key < 3)
                                <div class="col-3">
                                    <input type="hidden" name="financial_year[{{ $financial_year_key }}]" value="{{ $financial_year_item->financial_year }}">
                                    <h5 class="secondary_font_color">{{ $financial_year_item->financial_year }}</h5>
                                                    ...
                                                    <td class="w-25" style="width: 25%">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-7 p-0 m-0">
                                                                <input type="text"
                                                                       class="number-input border-0 w-100 m-0 ps-2 fifth_font_color fw-bold small
                                                                            {{ $comprehensive_arr_item == 'Gross Profit' ? 'four_bg_color' : 'primary_font_color' }}"
                                                                       name="{{ $comprehensive_arr['id'][$comprehensive_arr_key] }}[{{ $i }}]" id="{{ $comprehensive_arr['id'][$comprehensive_arr_key].'-'.$i }}"
                                                                       value="{{ number_format($comprehensive_arr['data'][$comprehensive_arr_key][$i], 0, '.', ',') }}" readonly >
                                                            </div>
                                ...
                                <table class="table form-table-two">
                                    ...
                                    <tr class="w-100">
                                        ...
                                        @for($i = 0; $i < 3; $i++)
                                            ...
                                            @if($i % 2 == 0)
                                                <td class="w-25">
                                                    <input type="text" class="number-input border-0 w-100 m-0 six_font_color fw-bold small font-light-custom" name="dsr[{{ $i }}]" id="dsr-{{ $i }}" value="0">
                                                </td>
                                            @else
                                                <td class="w-25">
                                                    <input type="text" class="number-input border-0 w-100 m-0 six_font_color fw-bold small font-light-custom" name="dsr[{{ $i }}]" id="dsr-{{ $i }}" value="0">
                                    ...
                                    <tr class="w-100">
                                        ...
                                        @for($i = 0; $i < 3; $i++)
                                            ...
                                            @if($i % 2 == 0)
                                                <td class="w-25">
                                                    <input type="text" class="number-input border-0 w-100 m-0 fw-bold small six_font_color" name="gearing[{{ $i }}]" id="gearing-{{ $i }}" value="0">
                                                </td>
                                            @else
                                                <td class="w-25">
                                                    <input type="text" class="number-input border-0 w-100 m-0 fw-bold small six_font_color" name="gearing[{{ $i }}]" id="gearing-{{ $i }}" value="0">
    ...
    <div class="mb-4 mt-3 card p-3">
        ...
        <div class="card-body" id="chart-with-block">
            <div class="row">
                <div class="col-3">
                </div>
                <div class="col-6">
                    <div class="d-flex justify-content-center" style="width: 100%">
                        <div class="flot-chart-placeholder d-none d-sm-none d-md-none d-lg-none d-xl-none d-xxl-block chart-block" id="chart-block-0"
                        ...
                        <div class="flot-chart-placeholder d-none d-sm-none d-md-none d-lg-none d-xl-block d-xxl-none chart-block" id="chart-block-1"
                             style="height: 250px; width: 40%; background-color: #c4def1; margin-top: 50px; margin-left: 50%; position: absolute; z-index: 2; filter: blur(7px)"></div>

                        <div class="flot-chart-placeholder d-none d-sm-none d-md-none d-lg-block d-xl-none d-xxl-none chart-block" id="chart-block-2"
                        ...
                        <div class="flot-chart-placeholder d-none d-sm-none d-md-block d-lg-none d-xl-none d-xxl-none chart-block" id="chart-block-3"
                        ...
                        <div class="flot-chart-placeholder d-none d-md-flex justify-content-center" id="report_chart1"></div>
                    </div>
                </div>
                <div class="col-3">
                </div>
        ...
        <div class="card-body" id="chart-with-none">
            <div class="row">
                <div class="col-3">
                </div>
                <div class="col-6">
                    <div class="d-flex justify-content-center" style="width: 100%" >
                        <div class="flot-chart-placeholder d-none d-md-flex justify-content-center" id="report_chart2"></div>
                    </div>
                </div>
                <div class="col-3">
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        function showAnsFunc(){
            for (var i = 0; i < 3; i++){
                if ($('#switch-show-ans').is(":checked")){
                    $('#gearing-'+i).removeClass('blurry-text');
                    $('#gearing-'+i).addClass('six_font_color');

                    $('#dsr-'+i).removeClass('blurry-text');
                    $('#dsr-'+i).addClass('six_font_color');

                    $('#chart-with-block').hide();
                    $('#chart-with-none').show();
                }
                else {
                    $('#gearing-'+i).addClass('blurry-text');
                    $('#gearing-'+i).removeClass('six_font_color');

                    $('#dsr-'+i).addClass('blurry-text');
                    $('#dsr-'+i).removeClass('six_font_color');

                    $('#chart-with-block').show();
                    $('#chart-with-none').hide();
        ...
        var chart = new ApexCharts(document.querySelector("#report_chart1"), options);
        chart.render();

        var chart = new ApexCharts(document.querySelector("#report_chart2"), options);
        chart.render();
        ...
        $( document ).ready(function() {
            ...
            for (var i = 0; i < 3; i++){
                ...
                if (dsr_val >= 1.6){
                    dsr.attr('style', 'background-color: #60f781 !important')
                    dsr.parent().attr('style', 'background-color: #60f781 !important')
